...
description: Retrieve sector performance metrics (revenue, EBITDA, net income, market cap) via Octagon MCP. Use for sector-wide financial analysis across companies and exchanges.
---
