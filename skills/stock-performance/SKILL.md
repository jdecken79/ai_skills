...
description: Retrieve stock price data and performance metrics via Octagon MCP. Use for analyzing closing prices, trading volume, price trends, and historical performance over time.
---
