...
description: Retrieve analyst price target summary for any stock via Octagon MCP. Use for evaluating analyst sentiment, upside/downside potential, and tracking target trends over time.
---
