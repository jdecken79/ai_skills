...
description: Retrieve real-time commodity price quotes via Octagon MCP. Use for current prices, day ranges, moving averages, and tracking metals, energy, and agricultural commodities.
---
