...
description: Retrieve full catalog of tradable commodities (energy, metals, agriculture) via Octagon MCP. Use for commodity market research, sector coverage, and market participant analysis.
---
