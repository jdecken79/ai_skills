...
description: Retrieve market capitalization for a single company via Octagon MCP. Use for current market value, valuation context, or size classification of any publicly traded stock.
---
