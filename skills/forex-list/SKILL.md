---
name: forex-list
description: Retrieve listing of actively traded currency pairs (majors, crosses, exotics) via Octagon MCP. Use for forex market research, pair categorization, and trading opportunity analysis.
---
