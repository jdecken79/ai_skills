---
name: stock-grades
description: Retrieve latest stock grades and ratings from analysts via Octagon MCP. Use for tracking upgrades, downgrades, rating changes, and institutional sentiment over time.
---
